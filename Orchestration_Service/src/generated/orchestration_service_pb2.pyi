...
class CreateJobRequest(_message.Message):
    __slots__ = ("job_name", "service_id", "initial_job_data")
    ...
    def __init__(self, job_name: _Optional[str] = ..., service_id: _Optional[str] = ..., initial_job_data: _Optional[_Mapping[str, str]] = ...) -> None: ...
...
class NotifyJobRequest(_message.Message):
    ...
    def __init__(self, task_id: _Optional[str] = ..., notification: _Optional[_Mapping[str, str]] = ...) -> None: ...
...
class TaskErrorRequest(_message.Message):
    ...
    task_id: str
    error_message: str
    def __init__(self, task_id: _Optional[str] = ..., error_message: _Optional[str] = ...) -> None: ...
