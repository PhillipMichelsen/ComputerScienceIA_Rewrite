...
class CreateJobRequest(_message.Message):
    __slots__ = ("job_name", "request_id", "initial_job_data")
    ...
    def __init__(self, job_name: _Optional[str] = ..., request_id: _Optional[str] = ...,
                 initial_job_data: _Optional[_Mapping[str, str]] = ...) -> None: ...
